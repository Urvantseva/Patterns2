...
public class AuthTest {
    ...
    @Test
    @DisplayName("An error message should appear if you log in with a blocked registered user")
    ...
    @Test
    @DisplayName("An error message should appear if you log in with the wrong login")
    ...
    @Test
    @DisplayName("An error message should appear if you log in with the wrong password")
